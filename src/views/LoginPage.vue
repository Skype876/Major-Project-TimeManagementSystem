...
<template>
    <div class="flex min-h-screen flex-col">
        ...
        <main class="flex-1 flex items-center justify-center p-4">
            <div class="mx-auto max-w-4xl w-full rounded-lg border bg-card text-card-foreground shadow-sm overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <!-- Left side - Image -->
                    <div class="hidden md:block relative bg-blue-600">
                        <img 
                            src="https://www.utech.edu.jm/UTechGraduatesat2018GraduationCeremonyNovember3atthePapineCampus.jpg" 
                            alt="Student studying" 
                            class="object-cover h-full w-full opacity-95"
                        />
                        <div class="absolute inset-0 bg-blue-600/20 flex flex-col justify-end p-6">
                            ...
                            <p class="text-white/90 text-sm">Empowering Academic Staff with Seamless Access to Effectively Address Student Queries and Concerns</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex flex-col space-y-1.5 p-6">
                            ...
                            <p class="text-sm text-muted-foreground">Select your role and enter your credentials to login</p>
                        </div>
                        <div class="p-6 pt-0">
                            <div class="w-full">
